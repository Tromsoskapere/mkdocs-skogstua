...
Målet er at alle i foreningen skal kunne bidra med oppdatering av dokumentasjonen for verkstedet. Du trenger ikke installere egen programvare for å gjøre enkle tekstendringer. Ved å redigere filer her på GitHub vil hjemmesiden oppdateres etter en admin har godkjent endringen.

Navigasjonsstrukturen på docs.tromsoskapere.no er en direkte avspeiling av katalogstrukturen i /docs/. Filene er lagret i [markdown-format](https://www.markdownguide.org/basic-syntax/), med .md endelse. Hver fil blir en egen html side. Alle .md filer må starte med `# Tittel`. Bilder laster du opp i images mappen og legger inn med `![Bildetekst](/images/eksempelbilde.png)`
